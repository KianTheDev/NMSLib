...
import net.minecraft.server.v1_9_R1.PathfinderGoalInteractVillagers;
...
public class CustomEntityVillager extends EntityVillager
{
	...
	public CustomEntityVillager(net.minecraft.server.v1_9_R1.World world) 
	{
		super(world);
	}
	...
	protected void r()
	{
		...
		goalSelector.a(4, new PathfinderGoalLookAtPlayer(this, net.minecraft.server.v1_9_R1.EntityInsentient.class, 8F));
	}
