...
public enum CustomEntityType 
{
	...
	ZOMBIE("Zombie", 54, EntityType.ZOMBIE, EntityZombie.class, CustomEntityZombie.class), EVIL_PIG("EvilPig", 90, EntityType.PIG, EntitySilverfish.class, CustomEntityEvilPig.class), EVIL_COW("EvilCow", 92, EntityType.COW, EntitySilverfish.class, CustomEntityEvilCow.class),
	VILLAGER_IMMOBILE("VillagerImmobile", 120, EntityType.VILLAGER, EntityVillager.class, CustomEntityVillagerImmobile.class), VILLAGER("Villager", 120, EntityType.VILLAGER, EntityVillager.class, CustomEntityVillager.class), EVIL_VILLAGER("EvilVillager", 120, EntityType.VILLAGER, EntitySilverfish.class, CustomEntityEvilVillager.class);
