...
public class CustomEntityEvilPig extends EntitySilverfish
{
	
	public CustomEntityEvilPig(net.minecraft.server.v1_9_R1.World world) 
	{
		super(world);
	}
	...
	protected void r()
	{
		...
		goalSelector.a(6, new PathfinderGoalLookAtPlayer(this, net.minecraft.server.v1_9_R1.EntityHuman.class, 8F));
		...
		targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, net.minecraft.server.v1_9_R1.EntityHuman.class, true));
	}
