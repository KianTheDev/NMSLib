...
public class Items 
{
	...
	public void initialize()
	{
		...
		masterItemList.add(new CItem(3, 0, 0, 3, 0, ItemEffect.MELEE, Material.STONE_SWORD, ItemType.WEAPON_MELEE, "Shortsword", false));
		masterItemList.add(new CItem(4, 0, 0, 2, 20, ItemEffect.RANGED, Material.BOW, ItemType.WEAPON_RANGED, "Shortbow", false));
		...
		masterItemList.add(new CItem(7, 0, 0, 5, 0, ItemEffect.DEFENSE, Material.LEATHER_CHESTPLATE, ItemType.ARMOR, "Scratched Leather Cuirass", false));
		masterItemList.add(new CItem(8, 0, 0, 5, 0, ItemEffect.DEFENSE, Material.LEATHER_HELMET, ItemType.ARMOR, "Scratched Leather Cap", false));
	}
